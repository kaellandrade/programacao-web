...
import Card_Quantidade from "../../componentes/card-quantidade/Card_Quantidade";

function Main() {

  var pergunta1 = "Qual a quantidade de cédulas e moedas circuladas em cada mês de cada ano?"
  ...
  var pergunta2 = "Qual a diferença percentual da quantidade de cada denominação ao longo dos anos? (sempre referente ao ano anterior)"
