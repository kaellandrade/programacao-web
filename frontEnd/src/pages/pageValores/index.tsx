...
function Main() {
  ...
  const extenso2 = 'Um bilhão, duzentos e três milhões e trezentos e trinta e três reais e cinco centavos';
  ...
  const extenso3 = 'Oitenta e dois bilhões e cento e cinquenta e um milhões de reais e 12 centavos';
  ...
  const extenso4 = 'Quarenta e nove bilhões e duzentos e três milhões e trezentos e trinta e três e duzentos e vinte e trrês reais e cinco centavos';
