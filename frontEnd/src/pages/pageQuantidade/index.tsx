...
function Main() {
	const pergunta1 =
		'Qual a quantidade de cédulas e moedas circuladas em cada mês de cada ano?';
	...
	const pergunta2 =
		'Qual a diferença percentual da quantidade de cada denominação ao longo dos anos? (sempre referente ao ano anterior)';
