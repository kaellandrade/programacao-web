...
function Main() {
  ...
  var pergunta1 = "Quais as denominações e suas respectivas quantidades em circulação em um intervalo de anos?"
  var pergunta2 = "Quais as categorias e suas respectivas quantidades em circulação em um intervalo de anos?"
        ...
        <section>
          ...
          <div className="container valores">
            <div className="column valores">
              <Card_Ranking pergunta={pergunta1} data={data1} colunas={colunas1} />
            </div>
            <div className="column valores">
              <Card_Ranking pergunta={pergunta2} data={data2} colunas={colunas2} />
            </div>
          </div>
        </section>
      </main>
