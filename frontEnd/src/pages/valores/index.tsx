        ...
        <section>
          ...
          <div className="container valores">
            <div className="column valores">
              <Card_Valores pergunta={pergunta1} valor_moeda_data={valor_moeda_data} valor_extenso={extenso1} />
              <Card_Valores pergunta={pergunta2} valor_moeda_data={valor_moeda_ano} valor_extenso={extenso2} />
            </div>
            <div className="column valores">
              <Card_Valores pergunta={pergunta3} valor_moeda_data={valor_cedula_data} valor_extenso={extenso3} />
              <Card_Valores pergunta={pergunta4} valor_moeda_data={valor_cedula_ano} valor_extenso={extenso4} />
            </div>
          </div>
        </section>
      </main>
